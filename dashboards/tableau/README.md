...
| `dem-distributions-public.twb` | `Distributions & Summary (web)` (800×1400) | `DistributionsSummaryweb` | `dem.csv` + `historic_events.csv` (one union), `dem_slip_bin_stats.csv` (separate source) | [distributions](../../docs/dashboards/distributions.md) |
